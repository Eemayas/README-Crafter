      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "relative z-50 flex max-h-[90%] min-h-[50%] max-w-[90%] flex-1 flex-col overflow-hidden rounded-2xl border border-transparent bg-white dark:border-neutral-800 dark:bg-neutral-950 lg:max-w-[60%] xl:max-w-[40%]",
              className,
            )}
            initial={{
              opacity: 0,
